      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (context, state) => const RequestListScreen().withProvider(
              (_) => RequestListCubit(),
            ),
          ),
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return const RequestDetailScreen().withProvider(
          ...
          GoRoute(
            ...
            builder: (context, state) => const InventoryListScreen()
                .withProvider((_) => InventoryListCubit()),
          ),
          GoRoute(
            ...
            builder: (context, state) {
              final id = Uri.decodeComponent(state.pathParameters['id'] ?? '');
              return const InventoryDetailScreen().withProvider(
          ...
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return InventoryTimelineScreen(
